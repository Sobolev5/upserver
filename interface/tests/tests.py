...
def test_catch_any_logger():
    # python run.py tests.tests "test_catch_any_logger()"

    row = {'payload': {'hello': 'world'}, 
            'tag': 'throwed', 
            'routing_key': 'any_logger', 
            'ttl': 180, 
            'filename': '/external-main/apps/main/views.py', 
...
def test_django_logger():
    # python run.py tests.tests "test_django_logger()"

    row = {
        "payload":{
            "uuid":"MkDQs68KmPtBFhFESFzGSu",
            "asctime":"2023-03-16T06:55:46.280989",
            "exc_info":"Traceback (most recent call last):\n  File \"/var/www/dev/dev1/external-main/env/lib/python3.10/site-packages/django/core/handlers/exception.py\", line 55, in inner\n    response = get_response(request)\n  File \"/var/www/dev/dev1/external-main/env/lib/python3.10/site-packages/django/core/handlers/base.py\", line 197, in _get_response\n    response = wrapped_callback(request, *callback_args, **callback_kwargs)\n  File \"/var/www/dev/dev1/external-main/apps/userprofiles/decorators.py\", line 158, in inner_decorator\n    return function(request, *args, **kwargs)\n  File \"/var/www/dev/dev1/external-main/apps/main/views.py\", line 119, in profile\n    throw(payload=payload, uri=COLLECTOR_AMQP_URI, routing_key=\"any_logger\", ttl=ttl)\nNameError: name \\'payload\\' is not defined",
            ...
            "args":"()",
            "kwargs":"{}",
            "pathname":"/var/www/dev/dev1/external-main/env/lib/python3.10/site-packages/django/utils/log.py",
        ...
        "ttl":180,
        "filename":"/var/www/dev/dev1/external-main/__sys_collector__.py",
